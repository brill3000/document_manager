            ...
            async queryFn(queryParams) {
                try {
                    ...
                    switch (queryParams.route) {
                        ...
                        case '/documents':
                            const myDocQuery = query(collection(db, "folders"), where("parent", "==", queryParams.parent), where("created_by", '==', queryParams.user), where("trashed", '==', false));
                        ...
                        case '/documents/trash':
                            if (queryParams.parent) {
                                const trashedQuery = query(collection(db, "folders"), where("created_by", '==', queryParams.user), where("trashed", '==', true));
                        ...
                        case '/documents/document-for-my-approval':
                            const approvalDocQuery = query(collection(db, "folders"), where("parent", "==", queryParams.parent), where("created_by", '==', queryParams.user), where("trashed", '==', false));
                        ...
                        default:
                            const defaultQuery = query(collection(db, "folders"), where("parent", "==", queryParams.parent), where("created_by", '==', queryParams.user), where("trashed", '==', false));
