...
const workflowConverter = {
    ...
    fromFirestore: (snapshot) => {
        ...
        return new Workflow(data.id, data.title, data.created_by, data.date_created, data.date_modified, data.nodes, data.edges, data.viewport);
    }
};
// Firestore data converter
