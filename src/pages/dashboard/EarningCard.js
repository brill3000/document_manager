...
const EarningCard = ({ isLoading, count, title, color }) => {
    ...
    return (
        <>
            {isLoading ? (
                ...
                <CardWrapper border={false} content={false} color={color ?? 'primary'}>
                    <Box sx={{ p: 2.25 }}>
                                    ...
                                    <Grid item>
                                        ...
                                        >
                                            <MenuItem onClick={handleClose}>
                                                <GetAppTwoToneIcon sx={{ mr: 1.75 }} /> Open In New Tab
                                            </MenuItem>
                                            <MenuItem onClick={handleClose}>
                                                <FileCopyTwoToneIcon sx={{ mr: 1.75 }} /> Open in Window
                                            </MenuItem>
                                            <MenuItem onClick={handleClose}>
                                                <ArchiveTwoToneIcon sx={{ mr: 1.75 }} /> Dismiss
                                            </MenuItem>
                                        </Menu>
                                    </Grid>
                                </Grid>
