...
export default function Navigation({ department }: { department: string }) {
          ...
          >
            <ListItem>
              ...
              >
                ...
                <ListItemContent>{department} Members</ListItemContent>
              </ListItemButton>
            </ListItem>
            <ListItem>
              <ListItemButton
              ...
              >
                ...
                <ListItemContent>{department} Roles</ListItemContent>
              </ListItemButton>
            </ListItem>
            <ListItem>
              <ListItemButton
              ...
              >
                ...
                <ListItemContent>{department} Approvals</ListItemContent>
              </ListItemButton>
            </ListItem>
          </List>)
        }
          ...
          >
            ...
            <ListItem>
              <ListItemButton>
                ...
                <ListItemContent>React</ListItemContent>
              </ListItemButton>
            </ListItem>
          </List>)
        }
