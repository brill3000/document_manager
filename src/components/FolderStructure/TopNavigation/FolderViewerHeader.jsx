...
export function FolderViewerHeader({ history, setUploadedFiles, uploadedFiles, setHistory, setDocuments, documents }) {
    ...
    return (
        <Grid container direction="row">
            ...
            <Grid item xs={12}>
                <Stack direction="row" divider={<Divider orientation="vertical" flexItem />} spacing={2} justifyContent="flex-end">
                    <ButtonBase
                        variant="outlined"
                        sx={{
                            p: 0.5,
                    ...
                    >
                        <Stack direction="row">
                            ...
                            {matchDownSM ? (
                                ...
                                <Typography color={!currentFolder ? 'secondary.400' : 'secondary.600'}>Search</Typography>
                            )}
                        </Stack>
                    </ButtonBase>
                    <ButtonBase
                    ...
                    >
                        <Stack direction="row">
                            ...
                            {matchDownSM ? (
                                ...
                                <Typography color={!currentFolder ? 'secondary.400' : 'secondary.600'}>Download</Typography>
                            )}
                        </Stack>
                    </ButtonBase>
                        ...
                        {({ getRootProps, getInputProps }) => (
                            <ButtonBase
                                ...
                                sx={{
                                    ...
                                    border: '1 solid',
                                    borderColor: (theme) =>
                                        theme.palette.mode === 'dark' ? theme.palette.divider : theme.palette.primary.dark,
                                    '&:hover': {
                                ...
                                <Stack direction="row">
                                    <Box sx={{ p: 0.3 }}>
                                        <HiOutlineDocumentDownload
                                            style={{ fontSize: '16px', color: !currentFolder ? '#bfbfbf' : 'inherit' }}
                                        />
                                    </Box>
                                    {matchDownSM ? (
                                        <></>
                                    ) : (
                                        <Typography color={!currentFolder ? 'secondary.400' : 'secondary.600'}>Upload</Typography>
                                    )}
                                </Stack>
                            </ButtonBase>
                        )}
                        ...
                        >
                            <Stack direction="row">
                                ...
                                {matchDownSM ? (
                                    ...
                                    <Typography color={!currentFolder ? 'secondary.400' : 'secondary.600'}>Create Folder</Typography>
                                )}
                            </Stack>
                        </ButtonBase>
                    )}
