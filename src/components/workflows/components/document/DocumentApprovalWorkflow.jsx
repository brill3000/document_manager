            ...
            usersQuery.isError
                ...
                <Box spacing={1}
                    ...
                    <Formik
                        ...
                        {({
                            handleChange, handleBlur, handleSubmit, isSubmitting, setFieldValue
                            /* and other goodies */
                        }) => (
                            <form onSubmit={handleSubmit}>
                                <Stack direction={"column"} spacing={2}>
                                    ...
                                    />
                                    <FormikAutoComplete variant='outlined' multiple={true} name="approvers" sx={{ width: '100%' }} options={usersQuery.data.map(user => ({
                                        ...user,
                                        name: `${user.name.first_name} ${user.name.last_name}`
                                    })) ?? []} placeholder='Approval' setFieldValue={setFieldValue} />
                                    <Box
                                        sx={{
                                            maxHeight: 30
                                        }}
