...
import EmailNav from './components_backup/EmailNav';
import Mails from './components_backup/Mails';
import EmailContent from './components_backup/EmailContent';
            ...
            <Sheet variant="outlined" color="neutral" sx={{ borderRadius: 10, maxHeight: 650, overflowY: 'hidden' }}>
                ...
                {drawerOpen && (
                    <Layout.SideDrawer onClose={() => setDrawerOpen(false)}>
                        <EmailNav
                            ...
                            setSelectedIndex={(value: string) => setSelectedIndex(value)}
                        />
                    </Layout.SideDrawer>
                )}
                <Layout.Mail
                ...
                >
                    ...
                    <Layout.SidePane sx={{ maxHeight: 600, overflowY: 'auto', pb: 10 }}>
                        ...
                        {!collapseOthers && (
                            <Mails setSelectedMail={setSelectedMail} selectedMail={selectedMail} getMessageByUser={getMessageByUser} />
                        )}
                    </Layout.SidePane>
