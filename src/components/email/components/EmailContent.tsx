...
const EmailContent: React.FC<any> = ({ selectedMail, selectedUser, getMessageByUser, to, from }: { selectedMail: any, selectedUser: any, getMessageByUser: any, to: any, from: any }) => {
        ...
        to && from && (isFetching || isLoading) ?
          ...
          >
            <Stack direction="column">
              ...
              <Typography level='body2' sx={{ pl: 3 }}>Loading Conversation ...</Typography>
            </Stack>
          </Box>
          :
          to && from && isError ?
            ...
            >
              <Stack direction="column">
                ...
                <Typography level='body2' sx={{ pl: 3 }}>Error Loading Conversation ...</Typography>
              </Stack>
            </Box>
            :
            to && from && mails && Array.isArray(mails) && mails.length > 0 ?
                ...
                <Stack direction="column">
                  {
                    ...
                    >
                      <Chip variant="outlined" startDecorator={<PersonRounded />}>
                        <Typography level="body3" color="neutral">{selectedUser.name}</Typography>
                      </Chip>
                    </Box>
                  }
                  <List>
              ...
              >
                ...
                >
                  ...
                  <Typography level='body2' sx={{ pl: 3 }}>No Conversation ...</Typography>
                </Stack>
              </Stack>
