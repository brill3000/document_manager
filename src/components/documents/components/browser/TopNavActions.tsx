        ...
        <div>
            <Stack
                sx={{
                    ...
                    borderRadius: 1,
                    bgcolor: alpha(theme.palette.text.secondary, .01),
            ...
            >
                <Stack direction='row'
                    ...
                    <HtmlTooltip arrow enterNextDelay={tooltipDelay} placement='top-end' title={
                        <React.Fragment>
                            <Typography color="inherit" variant='body2' sx={{ textDecoration: 'underline' }}>Create New Folder</Typography>
                        ...
                        >
                            ...
                            <Typography variant='caption' fontSize={10.5} display={md ? 'none' : 'block'}>Create Folder</Typography>
                        </Stack>
                    </HtmlTooltip>

                    <Dropzone onDrop={changeHandler}>
                        {({ getRootProps, getInputProps }) => (
                            <HtmlTooltip arrow enterNextDelay={tooltipDelay} placement='top' title={
                                <React.Fragment>
                                    <React.Fragment>
                                        <Typography color="inherit" variant='body2' sx={{ textDecoration: 'underline' }}>Upload New files</Typography>
                                ...
                                >
                                    ...
                                    <Typography variant='caption' fontSize={10.5} display={md ? 'none' : 'block'}>Upload files</Typography>
                                    <input {...getInputProps()} />
                                </Stack>
                ...
                */}
                <Stack
                    ...
                    <HtmlTooltip arrow enterNextDelay={tooltipDelay} placement='top' title={
                        <React.Fragment>
                            <Typography color="inherit" variant='body2' sx={{ textDecoration: 'underline' }}>Swith to list or table view</Typography>
                        ...
                        >
                            ...
                            <Typography variant='caption' fontSize={10.5} display={md ? 'none' : 'block'}>List View</Typography>
                        </Stack>
                    </HtmlTooltip>
                    <HtmlTooltip arrow enterNextDelay={tooltipDelay} placement='top' title={
                        <React.Fragment>
                            <Typography color="inherit" variant='body2' sx={{ textDecoration: 'underline' }}>Swith to Grid view</Typography>
                        ...
                        >
                            <BsGrid size={18.5} />
                            <Typography variant='caption' fontSize={10.5} display={md ? 'none' : 'block'}>Icon View</Typography>
                ...
                <Stack
                    ...
                    <HtmlTooltip arrow enterNextDelay={tooltipDelay} placement='top' title={
                        <React.Fragment>
                            <Typography color="inherit" variant='body2' sx={{ textDecoration: 'underline' }}>Edit file/folder</Typography>
                            <Typography fontSize={10.5}>This button allows you to edit the selected file/folder&apos;s details</Typography>
                        ...
                        >
                            ...
                            <Typography variant='caption' fontSize={10.5} display={md ? 'none' : 'block'}>Edit Files</Typography>
                        </Stack>
                    </HtmlTooltip>
                    <HtmlTooltip arrow enterNextDelay={tooltipDelay} placement='top-start' title={
                        <React.Fragment>
                            <Typography color="inherit" variant='body2' sx={{ textDecoration: 'underline' }}>Delete file/folder</Typography>
                        ...
                        >
                            ...
                            <Typography variant='caption' fontSize={10.5} display={md ? 'none' : 'block'}>Delete Folder</Typography>
                        </Stack>
                    </HtmlTooltip>
                </Stack>
            </Stack>
